 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const M="analytics",Ar="firebase_id",Sr="origin",Tr=60*1e3,Dr="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",re="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vr(e){if(!e.startsWith(re)){const t=g.create("invalid-gtag-resource",{gtagURL:e});return f.warn(t.message),""}return e}function nt(e){return Promise.all(e.map(t=>t.catch(n=>n)))}function Rr(e,t){let n;return window.trustedTypes&&(n=window.trustedTypes.createPolicy(e,t)),n}function Br(e,t){const n=Rr("firebase-js-sdk-policy",{createScriptURL:vr}),r=document.createElement("script"),a=`${re}?l=${e}&id=${t}`;r.src=n?n==null?void 0:n.createScriptURL(a):a,r.async=!0,document.head.appendChild(r)}function Or(e){let t=[];return Array.isArray(window[e])?t=window[e]:window[e]=t,t}async function kr(e,t,n,r,a,s){const i=r[a];try{if(i)await t[i];else{const c=(await nt(n)).find(l=>l.measurementId===a);c&&await t[c.appId]}}catch(o){f.error(o)}e("config",a,s)}async function Mr(e,t,n,r,a){try{let s=[];if(a&&a.send_to){let i=a.send_to;Array.isArray(i)||(i=[i]);const o=await nt(n);for(const c of i){const l=o.find(u=>u.measurementId===c),h=l&&t[l.appId];if(h)s.push(h);else{s=[];break}}}s.length===0&&(s=Object.values(t)),await Promise.all(s),e("event",r,a||{})}catch(s){f.error(s)}}function $r(e,t,n,r){async function a(s,...i){try{if(s==="event"){const[o,c]=i;await Mr(e,t,n,o,c)}else if(s==="config"){const[o,c]=i;await kr(e,t,n,r,o,c)}else if(s==="consent"){const[o,c]=i;e("consent",o,c)}else if(s==="get"){const[o,c,l]=i;e("get",o,c,l)}else if(s==="set"){const[o]=i;e("set",o)}else e(s,...i)}catch(o){f.error(o)}}return a}function Pr(e,t,n,r,a){let s=function(...i){window[r].push(arguments)};return window[a]&&typeof window[a]=="function"&&(s=window[a]),window[a]=$r(s,e,t,n),{gtagCore:s,wrappedGtag:window[a]}}function Nr(e){const t=window.document.getElementsByTagName("script");for(const n of Object.values(t))if(n.src&&n.src.includes(re)&&n.src.includes(e))return n;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yr{constructor(t){this.app=t}_delete(){return delete C[this.app.options.appId],Promise.resolve()}}let C={},be=[];const ye={};let z="dataLayer",Jr="gtag",Ie,st,we=!1;function Xr(){const e=[];if(It()&&e.push("This is a browser extension environment."),wt()||e.push("Cookies are not available."),e.length>0){const t=e.map((r,a)=>`(${a+1}) ${r}`).join(" "),n=g.create("invalid-analytics-context",{errorInfo:t});f.warn(n.message)}}function Zr(e,t,n){Xr();const r=e.options.appId;if(!r)throw g.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)f.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw g.create("no-api-key");if(C[r]!=null)throw g.create("already-exists",{id:r});if(!we){Or(z);const{wrappedGtag:s,gtagCore:i}=Pr(C,be,ye,z,Jr);st=s,Ie=i,we=!0}return C[r]=Kr(e,be,ye,t,Ie,z,n),new Yr(e)}function Qr(e=Tn()){e=Be(e);const t=P(e,M);return t.isInitialized()?t.getImmediate():ea(e)}function ea(e,t={}){const n=P(e,M);if(n.isInitialized()){const a=n.getImmediate();if(B(t,n.getOptions()))return a;throw g.create("already-initialized")}return n.initialize({options:t})}function X(e,t,n,r){e=Be(e),qr(st,C[e.app.options.appId],t,n,r).catch(a=>f.error(a))}const Ee="@firebase/analytics",_e="0.10.18";function ta(){A(new w(M,(t,{options:n})=>{const r=t.getProvider("app").getImmediate(),a=t.getProvider("installations-internal").getImmediate();return Zr(r,a,n)},"PUBLIC")),A(new w("analytics-internal",e,"PRIVATE")),I(Ee,_e),I(Ee,_e,"esm2020");function e(t){try{const n=t.getProvider(M).getImmediate();return{logEvent:(r,a,s)=>X(n,r,a,s)}}catch(n){throw g.create("interop-component-reg-failed",{reason:n})}}}ta();const na={apiKey:"AIzaSyBppSwQEO6I37LZVs9ZJ3dZpHWD-OnREow",authDomain:"testtracking-76a69.firebaseapp.com",projectId:"testtracking-76a69",storageBucket:"testtracking-76a69.firebasestorage.app",messagingSenderId:"787743860011",appId:"1:787743860011:web:f52283fcee96d4a74c116e",measurementId:"G-LV42Y5PZCH"},ra=Pe(na),Ae=Qr(ra),aa=["goal_scr_item_click","goal_scr_next_click","sex_age_scr_next_click","activity_level_click","height_weight_next_click","goal_weight_next_click","review_scr_next_click","nutrition_scr_next_click"],it="tracked_events";function sa(){try{return JSON.parse(localStorage.getItem(it))||[]}catch{return[]}}function ia(e){localStorage.setItem(it,JSON.stringify(e))}function oa(e,t={}){const n=sa();if(aa.includes(e)){if(n.includes(e)){console.log(`[Tracking] Event '${e}' đã gửi rồi, bỏ qua`);return}X(Ae,e,t),console.log(`[Tracking] Sent (once): ${e}`,t),n.push(e),ia(n)}else X(Ae,e,t),console.log(`[Tracking] Sent (multi): ${e}`,t)}export{Ae as a,oa as e,X as l};
