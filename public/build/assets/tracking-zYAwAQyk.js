 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _t="FirebaseError";class D extends Error{constructor(t,n,r){super(n),this.code=t,this.customData=r,this.name=_t,Object.setPrototypeOf(this,D.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,$.prototype.create)}}class ${constructor(t,n,r){this.service=t,this.serviceName=n,this.errors=r}create(t,...n){const r=n[0]||{},a=`${this.service}/${t}`,s=this.errors[t],i=s?Et(s,r):"Error",o=`${this.serviceName}: ${i} (${a}).`;return new D(a,o,r)}}function Et(e,t){return e.replace(At,(n,r)=>{const a=t[r];return a!=null?String(a):`<${r}?>`})}const At=/\{\$([^}]+)}/g;function B(e,t){if(e===t)return!0;const n=Object.keys(e),r=Object.keys(t);for(const a of n){if(!r.includes(a))return!1;const s=e[a],i=t[a];if(se(s)&&se(i)){if(!B(s,i))return!1}else if(s!==i)return!1}for(const a of r)if(!n.includes(a))return!1;return!0}function se(e){return e!==null&&typeof e=="object"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const St=1e3,Tt=2,Dt=14400*1e3,Ct=.5;function ie(e,t=St,n=Tt){const r=t*Math.pow(n,e),a=Math.round(Ct*r*(Math.random()-.5)*2);return Math.min(Dt,r+a)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const m=new ke("@firebase/app"),Kt="@firebase/app-compat",Yt="@firebase/analytics-compat",Jt="@firebase/analytics",Xt="@firebase/app-check-compat",Qt="@firebase/app-check",Zt="@firebase/auth",en="@firebase/auth-compat",tn="@firebase/database",nn="@firebase/data-connect",rn="@firebase/database-compat",an="@firebase/functions",sn="@firebase/functions-compat",on="@firebase/installations",cn="@firebase/installations-compat",ln="@firebase/messaging",dn="@firebase/messaging-compat",un="@firebase/performance",fn="@firebase/performance-compat",hn="@firebase/remote-config",pn="@firebase/remote-config-compat",gn="@firebase/storage",mn="@firebase/storage-compat",bn="@firebase/firestore",yn="@firebase/ai",In="@firebase/firestore-compat",wn="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const K="[DEFAULT]",_n={[G]:"fire-core",[Kt]:"fire-core-compat",[Jt]:"fire-analytics",[Yt]:"fire-analytics-compat",[Qt]:"fire-app-check",[Xt]:"fire-app-check-compat",[Zt]:"fire-auth",[en]:"fire-auth-compat",[tn]:"fire-rtdb",[nn]:"fire-data-connect",[rn]:"fire-rtdb-compat",[an]:"fire-fn",[sn]:"fire-fn-compat",[on]:"fire-iid",[cn]:"fire-iid-compat",[ln]:"fire-fcm",[dn]:"fire-fcm-compat",[un]:"fire-perf",[fn]:"fire-perf-compat",[hn]:"fire-rc",[pn]:"fire-rc-compat",[gn]:"fire-gcs",[mn]:"fire-gcs-compat",[bn]:"fire-fst",[In]:"fire-fst-compat",[yn]:"fire-vertex","fire-js":"fire-js",[wn]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pn(e){A(new w("platform-logger",t=>new qt(t),"PRIVATE")),A(new w("heartbeat",t=>new kn(t),"PRIVATE")),I(G,de,e),I(G,de,"esm2020"),I("fire-js","")}Pn("");var Nn="firebase",Fn="12.1.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qn({appConfig:e,heartbeatServiceProvider:t},{fid:n}){const r=Ue(e),a=qe(e),s=t.getImmediate({optional:!0});if(s){const l=await s.getHeartbeatsHeader();l&&a.append("x-firebase-client",l)}const i={fid:n,authVersion:je,appId:e.appId,sdkVersion:He},o={method:"POST",headers:a,body:JSON.stringify(i)},c=await Ge(()=>fetch(r,o));if(c.ok){const l=await c.json();return{fid:l.fid||n,registrationStatus:2,refreshToken:l.refreshToken,authToken:ze(l.authToken)}}else throw await We("Create Installation",c)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const er="firebase-installations-database",tr=1,T="firebase-installations-store";let V=null;function ee(){return V||(V=$e(er,tr,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(T)}}})),V}async function M(e,t){const n=N(e),a=(await ee()).transaction(T,"readwrite"),s=a.objectStore(T),i=await s.get(n);return await s.put(t,n),await a.done,(!i||i.fid!==t.fid)&&Je(e,t.fid),t}async function Qe(e){const t=N(e),r=(await ee()).transaction(T,"readwrite");await r.objectStore(T).delete(t),await r.done}async function F(e,t){const n=N(e),a=(await ee()).transaction(T,"readwrite"),s=a.objectStore(T),i=await s.get(n),o=t(i);return o===void 0?await s.delete(n):await s.put(o,n),await a.done,o&&(!i||i.fid!==o.fid)&&Je(e,o.fid),o}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function te(e){let t;const n=await F(e.appConfig,r=>{const a=nr(r),s=rr(e,a);return t=s.registrationPromise,s.installationEntry});return n.fid===J?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function nr(e){const t=e||{fid:Yn(),registrationStatus:0};return Ze(t)}function rr(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const a=Promise.reject(S.create("app-offline"));return{installationEntry:t,registrationPromise:a}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},r=ar(e,n);return{installationEntry:n,registrationPromise:r}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:sr(e)}:{installationEntry:t}}async function ar(e,t){try{const n=await qn(e,t);return M(e.appConfig,n)}catch(n){throw Ve(n)&&n.customData.serverCode===409?await Qe(e.appConfig):await M(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function sr(e){let t=await ge(e.appConfig);for(;t.registrationStatus===1;)await Ke(100),t=await ge(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:r}=await te(e);return r||n}return t}function ge(e){return F(e,t=>{if(!t)throw S.create("installation-not-found");return Ze(t)})}function Ze(e){return ir(e)?{fid:e.fid,registrationStatus:0}:e}function ir(e){return e.registrationStatus===1&&e.registrationTime+xe<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const O="analytics",Ar="firebase_id",Sr="origin",Tr=60*1e3,Dr="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",re="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vr(e){if(!e.startsWith(re)){const t=g.create("invalid-gtag-resource",{gtagURL:e});return f.warn(t.message),""}return e}function nt(e){return Promise.all(e.map(t=>t.catch(n=>n)))}function Rr(e,t){let n;return window.trustedTypes&&(n=window.trustedTypes.createPolicy(e,t)),n}function Br(e,t){const n=Rr("firebase-js-sdk-policy",{createScriptURL:vr}),r=document.createElement("script"),a=`${re}?l=${e}&id=${t}`;r.src=n?n==null?void 0:n.createScriptURL(a):a,r.async=!0,document.head.appendChild(r)}function kr(e){let t=[];return Array.isArray(window[e])?t=window[e]:window[e]=t,t}async function Mr(e,t,n,r,a,s){const i=r[a];try{if(i)await t[i];else{const c=(await nt(n)).find(l=>l.measurementId===a);c&&await t[c.appId]}}catch(o){f.error(o)}e("config",a,s)}async function Or(e,t,n,r,a){try{let s=[];if(a&&a.send_to){let i=a.send_to;Array.isArray(i)||(i=[i]);const o=await nt(n);for(const c of i){const l=o.find(u=>u.measurementId===c),h=l&&t[l.appId];if(h)s.push(h);else{s=[];break}}}s.length===0&&(s=Object.values(t)),await Promise.all(s),e("event",r,a||{})}catch(s){f.error(s)}}function $r(e,t,n,r){async function a(s,...i){try{if(s==="event"){const[o,c]=i;await Or(e,t,n,o,c)}else if(s==="config"){const[o,c]=i;await Mr(e,t,n,r,o,c)}else if(s==="consent"){const[o,c]=i;e("consent",o,c)}else if(s==="get"){const[o,c,l]=i;e("get",o,c,l)}else if(s==="set"){const[o]=i;e("set",o)}else e(s,...i)}catch(o){f.error(o)}}return a}function Pr(e,t,n,r,a){let s=function(...i){window[r].push(arguments)};return window[a]&&typeof window[a]=="function"&&(s=window[a]),window[a]=$r(s,e,t,n),{gtagCore:s,wrappedGtag:window[a]}}function Nr(e){const t=window.document.getElementsByTagName("script");for(const n of Object.values(t))if(n.src&&n.src.includes(re)&&n.src.includes(e))return n;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yr{constructor(t){this.app=t}_delete(){return delete C[this.app.options.appId],Promise.resolve()}}let C={},be=[];const ye={};let z="dataLayer",Jr="gtag",Ie,st,we=!1;function Xr(){const e=[];if(It()&&e.push("This is a browser extension environment."),wt()||e.push("Cookies are not available."),e.length>0){const t=e.map((r,a)=>`(${a+1}) ${r}`).join(" "),n=g.create("invalid-analytics-context",{errorInfo:t});f.warn(n.message)}}function Qr(e,t,n){Xr();const r=e.options.appId;if(!r)throw g.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)f.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw g.create("no-api-key");if(C[r]!=null)throw g.create("already-exists",{id:r});if(!we){kr(z);const{wrappedGtag:s,gtagCore:i}=Pr(C,be,ye,z,Jr);st=s,Ie=i,we=!0}return C[r]=Kr(e,be,ye,t,Ie,z,n),new Yr(e)}function Zr(e=Tn()){e=Be(e);const t=P(e,O);return t.isInitialized()?t.getImmediate():ea(e)}function ea(e,t={}){const n=P(e,O);if(n.isInitialized()){const a=n.getImmediate();if(B(t,n.getOptions()))return a;throw g.create("already-initialized")}return n.initialize({options:t})}function X(e,t,n,r){e=Be(e),qr(st,C[e.app.options.appId],t,n,r).catch(a=>f.error(a))}const _e="@firebase/analytics",Ee="0.10.18";function ta(){A(new w(O,(t,{options:n})=>{const r=t.getProvider("app").getImmediate(),a=t.getProvider("installations-internal").getImmediate();return Qr(r,a,n)},"PUBLIC")),A(new w("analytics-internal",e,"PRIVATE")),I(_e,Ee),I(_e,Ee,"esm2020");function e(t){try{const n=t.getProvider(O).getImmediate();return{logEvent:(r,a,s)=>X(n,r,a,s)}}catch(n){throw g.create("interop-component-reg-failed",{reason:n})}}}ta();const na={apiKey:"AIzaSyA00S-LJ5v1GiSDi79WIu0sGMty-xra3XY",authDomain:"hcmw01-heka-ai.firebaseapp.com",projectId:"hcmw01-heka-ai",storageBucket:"hcmw01-heka-ai.firebasestorage.app",messagingSenderId:"291097543865",appId:"1:291097543865:web:12d075cb2e9b67a5608768",measurementId:"G-QXFTNDCN33"},ra=Pe(na),Ae=Zr(ra),aa=["splash_scr","goal_scr_item_click","goal_scr_next_click","sex_age_scr_next_click","activity_level_click","height_weight_next_click","goal_weight_next_click","review_scr_next_click","nutrition_scr_next_click"],it="tracked_events";function sa(){try{return JSON.parse(localStorage.getItem(it))||[]}catch{return[]}}function ia(e){localStorage.setItem(it,JSON.stringify(e))}function oa(e,t={}){const n=sa();if(aa.includes(e)){if(n.includes(e))return;X(Ae,e,t),n.push(e),ia(n)}else{if(X(Ae,e,t),e==="iap_successfull"){const r=localStorage.getItem("session_id");fbq("track","Purchase",{value:0,currency:"USD",session_id:r})}e==="iap_btn_click"&&fbq("track","InitiateCheckout")}}export{Ae as a,oa as e,X as l};
