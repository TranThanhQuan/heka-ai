 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tt="installations",Ir="installations-internal",wr=e=>{const t=e.getProvider("app").getImmediate(),n=yr(t),r=P(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},_r=e=>{const t=e.getProvider("app").getImmediate(),n=P(t,tt).getImmediate();return{getId:()=>gr(n),getToken:a=>mr(n,a)}};function Er(){A(new w(tt,wr,"PUBLIC")),A(new w(Ir,_r,"PRIVATE"))}Er();I(Le,Q);I(Le,Q,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
