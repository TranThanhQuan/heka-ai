    ...
    <div class="w-full md:w-1/3 mx-auto overflow-y-auto pb-28 px-4">
      ...
      <div class="relative flex items-start">
        <div
          ...
          class="absolute right-0 top-0 w-3/5 sm:w-11/12 md:w-3/5 max-w-md py-2 px-4 text-left text-lg shadow-lg rounded-2xl bg-white flex items-center mr-1 sm:mr-16">
      ...
      <div class="flex justify-center gap-4 flex-wrap">
        <div @click="selectGender('male')" class="cursor-pointer">
          <img :src="gender === 'male' ? '/images/onboarding/male_active.png' : '/images/onboarding/male.png'"
            alt="Male" class=" w-36" />
        </div>
        <div @click="selectGender('female')" class="cursor-pointer">
          <img :src="gender === 'female' ? '/images/onboarding/female_active.png' : '/images/onboarding/female.png'"
            alt="Female" class=" w-36" />
        </div>
      </div>

      <!-- Select Birthday -->
      <div class="w-2/3 sm:w-2/3 md:w-1/2 mx-auto mt-6">
